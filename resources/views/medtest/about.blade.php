...
@section('content')
<!-- ***** Header Area End ***** -->
<section class="medica-services-area bg-gray section_padding_100">
    <div class="container">
        <div class="row">
            <div class="col-12">
            ...
            <div class="col-12 col-md-3 col-lg-4">
                <div class="medica-services-sidebar-area">
                    ...
                    <div class="medica-department-card">
                        <h3 style="color: white">Специальности </h3>
                        @foreach($specialies as $category)
                            <ul class="detipartment-menu">
                                <li><a style="color: white; font-size: 20px; margin-top: 20px" href="/about/slug/{{$category->name}}">{{$category->name}}</a></li>
