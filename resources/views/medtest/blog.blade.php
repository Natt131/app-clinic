                ...
                <div class="col-12 h-100">
                    <div class="main-menu h-100">
                        <nav class="navbar h-100 navbar-expand-lg">
                            <!-- Logo Area  -->
                            <a class="navbar-brand" href="index.blade.php"><img src="../../../img/core-img/logo.png" alt="Logo"></a>
                                ...
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="index.blade.php">Home</a>
                                            <a class="dropdown-item" href="about.blade.php">About Us</a>
                                            <a class="dropdown-item" href="services.blade.php">Services</a>
                                            <a class="dropdown-item" href="blog.blade.php">News</a>
                                            <a class="dropdown-item" href="contact.blade.php">Contact</a>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="blog.blade.php">News</a>
                                    </li>
                                    <li class="nav-item">
...
@foreach($response as $resp)
                ...
                <div class="single-blog-area" style=" display:inline-block">
                    <!-- Post Thumb -->
                    <div class="post-thumb">
                        <img src="{{$resp['articleImg']}} " style="float:left" alt="">
                        <!-- Post Date -->
                    {{--    <div class="post-date">
