                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="Department.blade.php">Department</a></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Services</h3>
                        <p><a href="index.blade.php">Home /</a> Services</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="../../../public/img/department/1.png" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="../../../public/img/department/2.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="../../../public/img/department/3.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="../../../public/img/department/4.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="../../../public/img/department/5.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="../../../public/img/department/6.png" alt="">
                        </div>
                        <div class="department_content">
                                    ...
                                    <div class="row align-items-center">
                                            ...
                                            <div class="col-xl-6 col-md-6">
                                                <div class="business_thumb">
                                                    <img src="../../../public/img/about/business.png" alt="">
                                                </div>
                                            </div>
                                        </div>
                            </div>
                    ...
                    <div class="expert_active owl-carousel">
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="../../../public/img/experts/1.png" alt="">
                            </div>
                        ...
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="../../../public/img/experts/2.png" alt="">
                            </div>
                            <div class="experts_name text-center">
                                <h3>Mirazul Alom</h3>
                                <span>Neurologist</span>
                        ...
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="../../../public/img/experts/3.png" alt="">
                            </div>
                            <div class="experts_name text-center">
                                <h3>Mirazul Alom</h3>
                                <span>Neurologist</span>
                        ...
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="../../../public/img/experts/4.png" alt="">
                            </div>
                            <div class="experts_name text-center">
                                <h3>Mirazul Alom</h3>
                                <span>Neurologist</span>
